...
//TAKE MENU DATA
$mydbcolumnsstr = "menu_id > ? AND menu_lang = ?";
...
?>
          ...
          <div class="main-content">
            ...
            <div class="row gutters">
                      ...
                      Menu List
                      <button type="button" class="btn  btn-success" style="float:right"  data-toggle="modal" data-target="#addModal"><i class="icon-plus"></i> New Menu</button>
                  </div>
									<div class="card-body">
                        ...
                        <?php if($result == false){ }else{ foreach($result as $key => $value){ ?>
                              ...
                              <?php } ?>
													...
													<td>
                            <?php if($value['menu_active'] == 1){?>
                              <button class="btn btn-warning btn-rounded"  data-toggle="modal" data-target="#pasModal" onclick="pasFunc('<?php echo $value["menu_id"]; ?>','<?php echo $value["menu_name"]; ?>')" ><i class="icon-star" style="color:white"></i></button>
                            <?php }else{ ?>
                              <button class="btn btn-success btn-rounded"  data-toggle="modal" data-target="#activeModal" onclick="actFunc('<?php echo $value["menu_id"]; ?>','<?php echo $value["menu_name"]; ?>')" ><i class="icon-star" style="color:white"></i></button>
                            <?php } ?>
                              <button class="btn btn-info btn-rounded"  data-toggle="modal" data-target="#cogModal" onclick="setFunc('<?php echo $value["menu_id"]; ?>')" ><i class="icon-settings" style="color:white"></i></button>
                              <button class="btn btn-danger btn-rounded"  data-toggle="modal" data-target="#delModal" onclick="delFunc('<?php echo $value["menu_id"]; ?>','<?php echo $value["menu_name"]; ?>')" ><i class="icon-trash" style="color:white"></i></button>
                          </td>
												</tr>
                        <?php } } ?>
											</tbody>
        ...
        <!-- END: .app-main -->
                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="./db/addmenu.php" method="POST"  enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addModalLabel">New Menu Form</h5>
                                ...
                                <div class="tab-pane fade show active" id="<?php echo $valuelang['lang_name'] ?>" role="tabpanel" aria-labelledby="<?php echo $valuelang['lang_name'] ?>-tab">
                                  <div class="form-row">
                                    <div class="form-group col-md-12">
                                      <label for="input1" class="col-form-label">Menu Name</label>
                                      <input type="text" required name="name-<?php echo $valuelang['lang_id'] ?>" class="form-control" id="input1" placeholder="Menu Name">
                                    </div>
                                    <div class="form-group col-md-12">
                                      <label for="input1" class="col-form-label">Menu Url</label>
                                      <input type="text" required name="url-<?php echo $valuelang['lang_id'] ?>" class="form-control" id="input1" placeholder="Menu Url">
                                    </div>
                                  </div>
                                </div>
                                <?php }else{ ?> 
                ...
                <div class="modal fade" id="cogModal" tabindex="-1" role="dialog" aria-labelledby="cogModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <form action="./db/setmenu.php" method="POST"  enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="cogModalLabel">Set Menu Form</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                              ...
                              <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="set<?php echo $valuelang['lang_name'] ?>" role="tabpanel" aria-labelledby="set<?php echo $valuelang['lang_name'] ?>-tab">
                                  <div class="form-row">
                                    <div class="form-group col-md-12">
                                      <label for="input1" class="col-form-label">Menu Name</label>
                                      <input type="text" required name="name-<?php echo $valuelang['lang_id'] ?>"  class="form-control" id="name-<?php echo $valuelang['lang_id'] ?>" placeholder="Menu Name">
                                    </div>
                                    <div class="form-group col-md-12">
                                      <label for="input1" class="col-form-label">Menu Url</label>
                                      <input type="text" required name="url-<?php echo $valuelang['lang_id'] ?>" class="form-control" id="url-<?php echo $valuelang['lang_id'] ?>" placeholder="Menu Url">
                                    </div>
                                  </div>
                                </div>
                                <?php }else{ ?> 
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary">Set Menu</button>
                            </div>
                        </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="delModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <form action="./db/delmenu.php" method="POST">
                            <div class="modal-header">
                                <h5 class="modal-title" id="delModalLabel">Delete Menu Form</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="pasModal" tabindex="-1" role="dialog" aria-labelledby="pasModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <form action="./db/statusmenu.php" method="POST">
                            <div class="modal-header">
...
<script>
    function setFunc(id,idb){
      $.post("./db/infomenu.php",{ id: ""+id+"" }, function(data,status){ 
        obj = JSON.parse(data);
