...
foreach ($lastArray as $key2 => $value2) {
    $mydbcolumnsstr = ["sub_service_name","sub_service_select_id","sub_service_uniqid","sub_service_lang","sub_service_active"];
    $mydbarray = [$value2['name'],$_POST['uniqid'],$uniq,$key2,1];
    $result = $dbcon->dbadd("sub_service",$mydbcolumnsstr,$mydbarray);
